    ...
    return (
        <VStack space="lg" className="space-y-5">
            <HStack className="space-x-4 items-center">
                <Text
                    className={`text-3xl font-extrabold tracking-normal pr-3 text-left ${isSignUp ? "text-gray-400" : ""
                        }`}
                    style={{
                        borderRightWidth: 2, 
                ...
                <Text
                    className={`text-3xl font-extrabold tracking-normal pl-3 text-left ${!isSignUp ? "text-gray-400" : ""
                        }`}
                >
                    Sign up
                </Text>
